...
class FRCNN(object):
    ...
    def visual_bbox(self, img):
        ...
        with torch.no_grad():
            ...
            if self.cuda:
                images = images.cuda()
            self.net = FasterRCNN(self.num_classes, "rpn", anchor_scales=self.anchors_size, backbone=self.backbone)
            rpn_locs, rpn_scores, rois, roi_indices, anchor = self.net(image)
